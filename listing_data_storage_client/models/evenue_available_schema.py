...
class EvenueAvailableSchema(BaseModel):
    """
    EvenueAvailableSchema
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["price_level_id", "price_level_secname", "price_min", "price_max", "facility_fee_max", "facility_fee_min", "facility_tiered_fee_min", "facility_tiered_fee_max", "per_ticket_fee_min", "per_ticket_fee_max", "per_ticket_fee_min_tiered", "per_ticket_fee_max_tiered", "seat_number", "seat_type", "place_id", "section", "row", "price"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EvenueAvailableSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EvenueAvailableSchema from a dict"""
        if obj is None:
            return None
