...
class EvenueChangeResponseSchema(BaseModel):
    """
    EvenueChangeResponseSchema
    """ # noqa: E501
    pagination: PaginationSchema
    info: ChangeInfo
    change_data: Optional[List[EvenueChangeSchema]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EvenueChangeResponseSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EvenueChangeResponseSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "change_data": [EvenueChangeSchema.from_dict(_item) for _item in obj["change_data"]] if obj.get("change_data") is not None else None
        })
        return _obj
