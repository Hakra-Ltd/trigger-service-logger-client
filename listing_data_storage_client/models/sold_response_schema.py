...
class SoldResponseSchema(BaseModel):
    """
    SoldResponseSchema
    """ # noqa: E501
    pagination: PaginationSchema
    sold_data: Optional[List[SoldSchema]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SoldResponseSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SoldResponseSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sold_data": [SoldSchema.from_dict(_item) for _item in obj["sold_data"]] if obj.get("sold_data") is not None else None
        })
        return _obj
