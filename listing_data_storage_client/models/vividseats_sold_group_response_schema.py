...
class VividseatsSoldGroupResponseSchema(BaseModel):
    """
    VividseatsSoldGroupResponseSchema
    """ # noqa: E501
    pagination: PaginationSchema
    info: SoldInfo
    sold_data: Optional[Dict[str, List[VividseatsSoldGroupSchema]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VividseatsSoldGroupResponseSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VividseatsSoldGroupResponseSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sold_data": dict(
                (_k,
                        [VividseatsSoldGroupSchema.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
